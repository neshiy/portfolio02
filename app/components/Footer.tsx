        ...
        <div className="flex items-center gap-4">
          {socials.map((s, i) => (
            <motion.a
              ...
              className="w-14 h-14 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-purple-400/40 hover:bg-purple-500/10 hover:shadow-[0_0_20px_rgba(168,85,247,0.15)] transition-all duration-300"
              aria-label={s.name}
